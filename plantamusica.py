...
st.set_page_config(layout="wide", page_title="Planta Musica [alpha-version v0.1.3]")

st.write("## THIS WILL NEED TO BE MODIFIED FOR NEW HOMEPAGE")
st.write("""
...
st.write("ROADMAP : Coming Soon. Gathering Feedback Now. ")
